...
*Laravel Reverb was developed by [Joe Dixon](https://github.com/joedixon)*.
...
*Per-second rate limiting was contributed by [Tim MacDonald](https://github.com/timacdonald)*.
...
*Health routing was contributed by [Taylor Otwell](https://github.com/taylorotwell)*.
...
*Graceful encryption key rotation was contributed by [Taylor Otwell](https://github.com/taylorotwell)*.
...
*Automatic password rehashing was contributed by [Stephen Rees-Carter](https://github.com/valorin)*.
...
*Prompt validator integration was contributed by [Andrea Marco Sartori](https://github.com/cerbero90)*.
...
*Queue interaction testing was contributed by [Taylor Otwell](https://github.com/taylorotwell)*.
...
*Class creation Artisan commands were contributed by [Taylor Otwell](https://github.com/taylorotwell)*.
...
*Model casts improvements were contributed by [Nuno Maduro](https://github.com/nunomaduro)*.
...
*The `once` helper was contributed by [Taylor Otwell](https://github.com/taylorotwell)* and *[Nuno Maduro](https://github.com/nunomaduro)*.
...
*Improved in-memory database testing performance was contributed by [Anders Jenbo](https://github.com/AJenbo)*
...
*Improved support for MariaDB was contributed by [Jonas Staudenmeir](https://github.com/staudenmeir) and [Julius Kiekbusch](https://github.com/Jubeki)*
...
*Improved schema operations and database inspection was contributed by [Hafez Divandari](https://github.com/hafezdivandari)*
