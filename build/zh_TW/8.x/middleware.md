...
deeper into the application (allowing the middleware to "pass"), you should
...
[group](/docs/{{version}}/routing#route-groups) of route definitions:
...
routes. Remember, these middleware groups are automatically applied by your
