...
[reduceMany](#method-reduce-many)  [reduceSpread](#method-reduce-spread)
...
[sliding](#method-sliding)  [skip](#method-skip)
...
`reduceMany` 方法會將該 Collection 歸約 (Reduce) 為一組包含值的陣列，並將每次迭代的結果傳遞給下一個迭代。這個方法與
`reduce` 方法類似，不過 `reduceMany` 接受多個初始值：
