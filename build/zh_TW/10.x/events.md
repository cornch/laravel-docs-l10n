...
- [測試](#testing)
   - [模擬部分的 Event](#faking-a-subset-of-events)
...
> **Note** 在測試時，若能在不實際觸發 Listener 的情況下判斷是否有分派特定 Event 會很實用。Laravel 的[內建測試輔助函式](#event-fake)就能讓我們在不實際觸發 Listener 的情況下分派 Event。
