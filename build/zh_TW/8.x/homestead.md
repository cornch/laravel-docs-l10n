...
including your local development environment. [Laravel
Homestead](https://github.com/laravel/homestead) is an official,
pre-packaged Vagrant box that provides you a wonderful development
...
Homestead runs on any Windows, macOS, or Linux system and includes Nginx,
...
- **HTTP:** 8000 &rarr; Forwards To 80 - **HTTPS:** 44300 &rarr; Forwards To
443
...
Below is a list of additional Homestead service ports that you may wish to
map from your host machine to your Vagrant box:

<div class="content-list" markdown="1">

- **SSH:** 2222 &rarr; To 22 - **ngrok UI:** 4040 &rarr; To 4040 -
**MySQL:** 33060 &rarr; To 3306 - **PostgreSQL:** 54320 &rarr; To 5432 -
**MongoDB:** 27017 &rarr; To 27017 - **Mailhog:** 8025 &rarr; To 8025 -
...
are: "5.6", "7.0", "7.1", "7.2", "7.3", "7.4", "8.0" (the default), and
"8.1":
...
Supported `policy` values include: `none`, `download`, `upload`, and
`public`.
...
By default, Xdebug is already running and ready to accept connections. If
...
Blackfire server credentials and client credentials [require a Blackfire
